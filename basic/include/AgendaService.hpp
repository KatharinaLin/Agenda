...
class AgendaService {
   public:
    ...
    /**
     * list all meetings the user sponsorAgendaService::
     * @param userName user's username
     * @return a meeting list result
     */
    ...
    bool changePassword(const std::string userName, const std::string password, const std::string NewPass);
    bool changeEmail(const std::string userName, const std::string password, const std::string NewEmail);
    bool changePhone(const std::string userName, const std::string password, const std::string NewPhone);
